    ...
    return (
        <div>
            <div className="md:container md:mx-auto px-5 lg:px-0 py-10">
                ...
                >
                    <div className="single-offer-box rounded-md flex items-center bg-opacity-75 bg-blend-overlay bg-black" style={{ backgroundImage: 'url(https://img.freepik.com/free-vector/promotion-sale-labels-best-offers_206725-127.jpg?size=626&ext=jpg)', width: '100%', height: '600px', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
                        <div className='px-10'>
                            <h3 className='text-white text-6xl font-medium mb-2'>Limited Offer</h3>
                            <p className=' py-2 font-semibold text-white'>Modern Products</p>
                            <p className='text-white'>This offer will be expire within next week. Be hurry to buy new products during this offer.</p>
                            <Link 
                            // to='/explore-cars'
                            >
